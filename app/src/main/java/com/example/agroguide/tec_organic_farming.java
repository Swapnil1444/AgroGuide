...
public class tec_organic_farming extends AppCompatActivity {

    Toolbar toolbar;
    TextView text1,text11,text12,text13,text14;
    LinearLayout text2,text21,text22,text23,text24;
    ImageView text3,text31,text32,text33,text34;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tec_organic_farming);
