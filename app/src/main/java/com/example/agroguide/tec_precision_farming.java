...
public class tec_precision_farming extends AppCompatActivity {

    Toolbar toolbar;
    TextView text1,text11,text12,text13,text14,text15;
    LinearLayout text2,text21,text22,text23,text24,text25;
    ImageView text3,text31,text32,text33,text34,text35;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tec_precision_farming);
